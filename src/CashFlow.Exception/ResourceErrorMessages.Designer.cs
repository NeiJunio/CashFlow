...
namespace CashFlow.Exception {
    ...
    public class ResourceErrorMessages {
        ...
        /// </summary>
        public static string AMOUN_MUST_BE_GREATER_THAN_ZERO {
            get {
                return ResourceManager.GetString("AMOUN_MUST_BE_GREATER_THAN_ZERO", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Consulta uma cadeia de caracteres localizada semelhante a Expanses cannot be for the future.
        /// </summary>
        public static string EXPENSES_CANNOT_FOR_THE_FUTURE {
            get {
                return ResourceManager.GetString("EXPENSES-CANNOT_FOR_THE_FUTURE", resourceCulture);
            }
        }
